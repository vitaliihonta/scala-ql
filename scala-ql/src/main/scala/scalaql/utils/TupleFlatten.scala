...
object TupleFlatten extends LowPriorityTupled0 {
  ...
  private[scalaql] def create[A, Out0: Tag](f: A => Out0): TupleFlatten.Of[A, Out0] =
    new TupleFlatten[A] {
      type Out = Out0
  ...
  implicit def tupled2[A: Tag, B: Tag, C: Tag, D: Tag]: TupleFlatten.Of[((A, B), (C, D)), (A, B, C, D)] =
  ...
  implicit def tupled2Plus3[
    ...
    D: Tag,
    E: Tag
  ]: TupleFlatten.Of[((A, B), (C, D, E)), (A, B, C, D, E)] =
  ...
  implicit def tupled3[
    ...
    E: Tag,
    F: Tag
  ]: TupleFlatten.Of[((A, B, C), (D, E, F)), (A, B, C, D, E, F)] =
...
sealed trait LowPriorityTupled0 extends LowPriorityTupled1 {
  implicit def tupled2Plus[A: Tag, B: Tag, C: Tag]: TupleFlatten.Of[((A, B), C), (A, B, C)] =
    TupleFlatten.create[((A, B), C), (A, B, C)] { case ((a, b), c) =>
      (a, b, c)
    }

  implicit def tupledPlus2[A: Tag, B: Tag, C: Tag]: TupleFlatten.Of[(A, (B, C)), (A, B, C)] =
    TupleFlatten.create[(A, (B, C)), (A, B, C)] { case (a, (b, c)) =>
      (a, b, c)
    }

  implicit def tupled3Plus[A: Tag, B: Tag, C: Tag, D: Tag]: TupleFlatten.Of[((A, B, C), D), (A, B, C, D)] =
    TupleFlatten.create[((A, B, C), D), (A, B, C, D)] { case ((a, b, c), d) =>
      (a, b, c, d)
    }

  implicit def tupledPlus3[A: Tag, B: Tag, C: Tag, D: Tag]: TupleFlatten.Of[(A, (B, C, D)), (A, B, C, D)] =
    TupleFlatten.create[(A, (B, C, D)), (A, B, C, D)] { case (a, (b, c, d)) =>
      (a, b, c, d)
    }
}
...
sealed trait LowPriorityTupled1 {
  implicit def tupled0[A: Tag]: TupleFlatten.Of[A, A] = TupleFlatten.create[A, A](identity)
}
