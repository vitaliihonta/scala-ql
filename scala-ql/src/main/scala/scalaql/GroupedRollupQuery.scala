...
//import scalaql.internal.{FatalExceptions, RollupKey, RollupMapKey}
...
//] private[scalaql] (
//  override protected val source: Query[In, Out],
//  group1:                        Out => RollupKey[G1],
//  group2:                        Out => RollupKey[G2],
